...
import "echarts";
import { getSpaceAnalyUploadUsingPost } from "@/api/spaceAnalyController.ts";
...
// 图表数据
const dataList = ref<API.SpaceAnalyUploadResponse[]>([]);
...
const fetchData = async () => {
  ...
  const res = await getSpaceAnalyUploadUsingPost({
